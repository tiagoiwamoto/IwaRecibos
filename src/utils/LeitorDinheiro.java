package utils;
	...
	*/
	...
	public class LeitorDinheiro {
		...
		private static LeitorDinheiro instance = null;
		
		public static LeitorDinheiro getInstance() {
			if (instance == null) {
				instance = new LeitorDinheiro();
			}

			return instance;
		}
		
		private LeitorDinheiro() {
